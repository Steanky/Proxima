 ...
 */
final class Util {
    static Bounds3D closestCollision(Solid solid, int x, int y, int z, double cx, double cy, double cz, double lx, double ly, double lz, Direction d, double l, double e) {
    ...
    static boolean hasCollision(Solid solid, int x, int y, int z, double cx, double cy, double cz, double lx, double ly, double lz, Direction d, double l, double e) {
        double dx = d.x * l;
        double dy = d.y * l;
        double dz = d.z * l;
    ...
    static boolean hasCollision(Solid solid, int x, int y, int z, double cx, double cy, double cz, double lx, double ly, double lz, double dx, double dy, double dz, double e) {
